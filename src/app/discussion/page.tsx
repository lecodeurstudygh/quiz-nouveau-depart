...
import { week01, week10, getAllDiscussionCards } from "@/data/courses";
...
export default function DiscussionPage() {
  ...
  const baseCards: DiscussionCardType[] = useMemo(() => {
    if (weekFilter === "week-01") return week01.discussionCards || [];
    if (weekFilter === "week-10") return week10.discussionCards || [];
    return getAllDiscussionCards();
  }, [weekFilter]);
          ...
          <div className="relative">
            ...
            >
              <option value="week-01">
                {language === "fr" ? "Semaine 1 : Sauveur (10 Q&A)" : "Week 1: Saviour (10 Q&A)"}
              </option>
              <option value="week-10">
                {language === "fr" ? "Semaine 10 : L'Église (8 Q&A)" : "Week 10: Church (8 Q&A)"}
              </option>
              <option value="all">
                {language === "fr" ? "Toutes les semaines (18 Q&A)" : "All Weeks (18 Q&A)"}
              </option>
            </select>
